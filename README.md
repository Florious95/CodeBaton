...
从 [Releases](releases) 下载对应平台的桌面客户端（macOS / Windows / Linux），两台机器各装一个，同一局域网内即可互相发现。

从源码构建见 [docs/BUILD.md](docs/BUILD.md)。

## 支持

| | |
|---|---|
| **平台** | macOS · Windows（含 WSL）· Linux |
